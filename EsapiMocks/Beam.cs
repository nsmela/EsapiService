...
namespace VMS.TPS.Common.Model.API
{
    public class Beam : ApiDataObject
    {
        public Beam()
        {
            ...
            CreationDateTime = new List<DateTime>();
        }

        public void AddBolus(IBolus bolus) { }
        public bool RemoveBolus(IBolus bolus) => default;
        public void AddBolus(string bolusId) { }
        public bool AddFlatteningSequence() => default;
        public void ApplyParameters(IBeamParameters beamParams) { }
        ...
        public void FitCollimatorToStructure(FitToStructureMargins margins, IStructure structure, bool useAsymmetricXJaws, bool useAsymmetricYJaws, bool optimizeCollimatorRotation) { }
        public void FitMLCToOutline(Windows.Point[][] outline) { }
        public void FitMLCToOutline(Windows.Point[][] outline, bool optimizeCollimatorRotation, JawFitting jawFit, OpenLeavesMeetingPoint olmp, ClosedLeavesMeetingPoint clmp) { }
        public void FitMLCToStructure(IStructure structure) { }
        public void FitMLCToStructure(FitToStructureMargins margins, IStructure structure, bool optimizeCollimatorRotation, JawFitting jawFit, OpenLeavesMeetingPoint olmp, ClosedLeavesMeetingPoint clmp) { }
        public double GantryAngleToUser(double val) => default;
        public double GetCAXPathLengthInBolus(IBolus bolus) => default;
        ...
        public double GetSourceToBolusDistance(IBolus bolus) => default;
        public Windows.Point[][] GetStructureOutlines(IStructure structure, bool inBEV) => default;
