...
{
    public partial class AsyncCalculation : ICalculation, IEsapiWrapper<VMS.TPS.Common.Model.API.Calculation>
    {
        ...
        public string AlgorithmsRootPath =>
            _inner.AlgorithmsRootPath;
