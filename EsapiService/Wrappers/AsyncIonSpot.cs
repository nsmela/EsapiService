...
{
    public partial class AsyncIonSpot : AsyncSerializableObject, IIonSpot, IEsapiWrapper<VMS.TPS.Common.Model.API.IonSpot>
    {
        ...
        IEsapiService IEsapiWrapper<VMS.TPS.Common.Model.API.IonSpot>.Service => _service;
    }
}
