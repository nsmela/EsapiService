...
{
    public partial class AsyncPlanningItem : AsyncApiDataObject, IPlanningItem, IEsapiWrapper<VMS.TPS.Common.Model.API.PlanningItem>
    {
        ...
        {
            get => _inner.DoseValuePresentation;
            set => _inner.DoseValuePresentation = value;
        }
