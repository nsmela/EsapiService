...
namespace EsapiService.Wrappers
{
    ...
    public class AsyncIonBeam : IIonBeam
    {
        ...
        public VMS.TPS.Common.Model.Types.ProtonDeliveryTimeStatus GetDeliveryTimeStatusByRoomId(string roomId) => _inner.GetDeliveryTimeStatusByRoomId(roomId);
        ...
        public VMS.TPS.Common.Model.Types.ProtonBeamLineStatus BeamLineStatus { get; }
        ...
        public System.Collections.Generic.IReadOnlyList<double> LateralMargins => _inner.LateralMargins?.ToList();
        public System.Collections.Generic.IReadOnlyList<ILateralSpreadingDevice> LateralSpreadingDevices => _inner.LateralSpreadingDevices?.Select(x => new AsyncLateralSpreadingDevice(x, _service)).ToList();
        public double NominalRange { get; }
        public double NominalSOBPWidth { get; }
        public string OptionId { get; }
        public string PatientSupportId { get; }
        public VMS.TPS.Common.Model.Types.PatientSupportType PatientSupportType { get; }
        ...
        public System.Collections.Generic.IReadOnlyList<IRangeModulator> RangeModulators => _inner.RangeModulators?.Select(x => new AsyncRangeModulator(x, _service)).ToList();
        public System.Collections.Generic.IReadOnlyList<IRangeShifter> RangeShifters => _inner.RangeShifters?.Select(x => new AsyncRangeShifter(x, _service)).ToList();
        public VMS.TPS.Common.Model.Types.IonBeamScanMode ScanMode { get; }
