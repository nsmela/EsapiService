...
namespace Esapi.Wrappers
{
    public class AsyncExternalPlanSetup : AsyncPlanSetup, IExternalPlanSetup
    {
        ...
        public Task<bool> AddImagingSetupAsync(ExternalBeamMachineParameters machineParameters, ImagingBeamSetupParameters setupParameters, IStructure targetStructure) => _service.PostAsync(context => _inner.AddImagingSetup(machineParameters, setupParameters, ((AsyncStructure)targetStructure)._inner));
