...
{
    public partial class AsyncTreatmentPhase : AsyncApiDataObject, ITreatmentPhase, IEsapiWrapper<VMS.TPS.Common.Model.API.TreatmentPhase>
    {
        ...
        public int PhaseGapNumberOfDays =>
            _inner.PhaseGapNumberOfDays;
