namespace EsapiService.Wrappers
{
    ...
    public class AsyncStructureSet : IStructureSet
    {
        ...
        public IStructure AddReferenceLine(string name, string id, VVector[] referenceLinePoints) => _inner.AddReferenceLine(name, id, referenceLinePoints) is var result && result is null ? null : new AsyncStructure(result, _service);
        ...
        public IStructure AddStructure(StructureCodeInfo code) => _inner.AddStructure(code) is var result && result is null ? null : new AsyncStructure(result, _service);
        ...
        public bool CanRemoveStructure(IStructure structure) => _inner.CanRemoveStructure(structure);
        public IStructureSet Copy() => _inner.Copy() is var result && result is null ? null : new AsyncStructureSet(result, _service);
        public IStructure CreateAndSearchBody(ISearchBodyParameters parameters) => _inner.CreateAndSearchBody(parameters) is var result && result is null ? null : new AsyncStructure(result, _service);
        ...
        public void RemoveStructure(IStructure structure) => _inner.RemoveStructure(structure);
        public IReadOnlyList<IStructure> Structures => _inner.Structures?.Select(x => new AsyncStructure(x, _service)).ToList();
