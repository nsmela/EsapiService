...
namespace Esapi.Interfaces
{
    public interface IHospital : IApiDataObject
    {
        ...
        /// </summary>
        Task RunAsync(Action<VMS.TPS.Common.Model.API.Hospital> action);

        /// <summary>
        /// Runs a function against the raw ESAPI VMS.TPS.Common.Model.API.Hospital object safely on the ESAPI thread.
        /// </summary>
        Task<T> RunAsync<T>(Func<VMS.TPS.Common.Model.API.Hospital, T> func);

        /// <summary>
        /// Updated the properties from the raw Esapi VMS.TPS.Common.Model.API.Hospital object
        /// </summary>
        new void Refresh();
    }
}
