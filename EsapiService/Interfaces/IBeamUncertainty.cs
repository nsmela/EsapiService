...
namespace Esapi.Interfaces
{
    public interface IBeamUncertainty : IApiDataObject
    {
        ...
        /// </summary>
        Task RunAsync(Action<VMS.TPS.Common.Model.API.BeamUncertainty> action);

        /// <summary>
        /// Runs a function against the raw ESAPI VMS.TPS.Common.Model.API.BeamUncertainty object safely on the ESAPI thread.
        /// </summary>
        Task<T> RunAsync<T>(Func<VMS.TPS.Common.Model.API.BeamUncertainty, T> func);

        /// <summary>
        /// Updated the properties from the raw Esapi VMS.TPS.Common.Model.API.BeamUncertainty object
        /// </summary>
        new void Refresh();
    }
}
